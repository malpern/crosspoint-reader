...
class GfxRenderer {
 ...
 public:
  ...
  // Windowed update - refreshes only a rectangular region (logical/orientation-aware coords).
  // Auto-aligns x and width to 8-px boundaries. X4 only; X3 falls back to a full refresh.
